      ...
      <div class="product-images">
        <div class="main-image">
          <div class="image-container">
            <img src="/product-photo.png" alt="Apple iPhone 14 Pro main image" class="img-main" />
          </div>
          <div class="thumbnail-images">
            <div class="thumbnail">
              <div class="thumbnail-container">
                <img src="/product-photo.png" alt="Apple iPhone 14 Pro thumbnail 1" class="img-thumbnail" />
              </div>
            </div>
            <div class="thumbnail">
              <div class="thumbnail-container">
                <img src="/product-photo.png" alt="Apple iPhone 14 Pro thumbnail 2" class="img-thumbnail" />
              </div>
            </div>
            <div class="thumbnail">
              <div class="thumbnail-container">
                <img src="/product-photo.png" alt="Apple iPhone 14 Pro thumbnail 3" class="img-thumbnail" />
              </div>
            </div>
            <div class="thumbnail">
              <div class="thumbnail-container">
                <img src="/product-photo.png" alt="Apple iPhone 14 Pro thumbnail 4" class="img-thumbnail" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="product-info">
        <div class="info-container">
          ...
          <div class="color-options">
            <div @click="selected_color = 'color_1'" class="color-option color1" :class="{active: selected_color === 'color_1'}"></div>
            <div @click="selected_color = 'color_2'" class="color-option color2" :class="{active: selected_color === 'color_2'}"></div>
            <div @click="selected_color = 'color_3'" class="color-option color3" :class="{active: selected_color === 'color_3'}"></div>
            <div @click="selected_color = 'color_4'" class="color-option color4" :class="{active: selected_color === 'color_4'}"></div>
          </div>
...
<style scoped>
  ...
  .image-container {
    background-color: var(--gray-gray-5, rgba(165, 169, 172, 0.05));
    display: flex;
    align-items: center;
  ...
  .color-label {
    ...
    align-self: start;
    margin-top: 26px;
    font: 700 18px/167% Montserrat, sans-serif;
  }
  ...
  .color2 {
    background-color: var(--Color-Option-Color-Option-4, #304fbe);
  }
  
  .color3 {
    background-color: var(--Dark-500, #101316);
  }
  
  .color4 {
    background-color: var(--Color-Option-Color-Option-3, #5d30be);
  }
